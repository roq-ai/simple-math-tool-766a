...
import { getMathToolById } from 'apiSdk/math-tools';
import { MathToolInterface } from 'interfaces/math-tool';
import { CalculationListPage } from 'pages/calculations';

function MathToolViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('math_tool', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/math-tools/edit/${id}`} passHref legacyBehavior>
                    <Button
